        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if (this.transport) {
                    ...
                    signatures = requiredKeys.map(function (pub) { return ecc.Signature.sign(signBuf, _this.keys.get((0, chain_numeric_1.convertLegacyPublicKey)(pub))).toString(); }, this.transport);
                }
